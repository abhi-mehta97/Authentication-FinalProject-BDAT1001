...
namespace Basics.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Authenticate()
        {
            ...
            {
                new Claim(ClaimTypes.Name, "Abhi"),
                new Claim(ClaimTypes.Email, "abhmehta@gmail.com"),
                new Claim(ClaimTypes.DateOfBirth, "11/12/2000"),
            ...
            {
                new Claim(ClaimTypes.Name, "Abhi B Mehta"),
